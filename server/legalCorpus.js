 ...
 * categorized (practice area + jurisdiction), and Grok's context window
 * comfortably fits every provision for a given category. Coarse filtering
 * here, real relevance judgement happens in the drafting prompt. Revisit
 * if/when the corpus grows into hundreds of acts across many states.
 */
 ...
 */
async function findProvisions({ practiceArea, jurisdiction, limit = 40 }) {
